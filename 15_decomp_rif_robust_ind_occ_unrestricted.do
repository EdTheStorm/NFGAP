...
capture log close
log using "$outputpfad\RIF_Decomp_rif_ind_occ_task_unrestricted", replace
...
graph export RIF_4_wgap_all_unrest.png, replace
...
graph export RIF_4_socio_all_unrest.png, replace
...
graph export RIF_4_foreign_all_unrest.png, replace
...
graph export RIF_4_educ_all_unrest.png, replace
...
graph export RIF_4_exp_all_unrest.png, replace
...
graph export RIF_4_tasks_occ_all_unrest.png, replace 
...
graph export RIF_4_tasks_ind_all_unrest.png, replace
...
graph export RIF_4_dummies_all_unrest.png, replace 
...
graph export RIF_4_tasks_ind_nra_ci_rel_unrest.png, replace  
...
graph export RIF_4_tasks_ind_nri_ci_rel_unrest.png, replace  
...
graph export RIF_4_tasks_ind_rm_ci_rel_unrest.png, replace  
...
graph export RIF_4_tasks_ind_nrm_ci_rel_unrest.png, replace  
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "95% CI"))
graph export RIF_4_wgap90_unrest.png, replace
...
graph twoway (connected age_rel gender_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Sex" 3 "Urban" 4 "95% CI"))
graph export RIF_4_socio90_unrest.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_4_foreign90_unrest.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_4_educ90_unrest.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_4_exp90_unrest.png, replace
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_4_dummies90_unrest.png, replace 
...
graph twoway (connected nra_ind_rel nra_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Analytic (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nra_ci_rel90_unrest.png, replace  
...
graph twoway (connected nri_ind_rel nri_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Interactive (Indiv.)" 2 "NR Interactive (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nri_ci_rel90_unrest.png, replace  
...
graph twoway (connected rm_ind_rel rm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Rout. Manual (Indiv.)" 2 "Rout. Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_rm_ci_rel90_unrest.png, replace  
...
graph twoway (connected nrm_ind_rel nrm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Manual (Indiv.)" 2 "NRM Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nrm_ci_rel90_unrest.png, replace   
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "95% CI"))
graph export RIF_4_wgap00_unrest.png, replace
...
graph twoway (connected age_rel gender_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Sex" 3 "Urban" 4 "95% CI"))
graph export RIF_4_socio00_unrest.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_4_foreign00_unrest.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_4_educ00_unrest.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_4_exp00_unrest.png, replace
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_4_dummies00_unrest.png, replace 
...
graph twoway (connected nra_ind_rel nra_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Analytic (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nra_ci_rel00_unrest.png, replace  
...
graph twoway (connected nri_ind_rel nri_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Interactive (Indiv.)" 2 "NR Interactive (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nri_ci_rel00_unrest.png, replace  
...
graph twoway (connected rm_ind_rel rm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Rout. Manual (Indiv.)" 2 "Rout. Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_rm_ci_rel00_unrest.png, replace  
...
graph twoway (connected nrm_ind_rel nrm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Manual (Indiv.)" 2 "NRM Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nrm_ci_rel00_unrest.png, replace  
...
graph twoway (connected nri_ind_rel nri_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   */  rarea lb_nri_ind_rel ub_nri_ind_rel quant, color(gray%40)  ||      /*
   */  rarea lb_nri_tot_rel ub_nri_tot_rel quant, color(gray%20)  ||      /*
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-0.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Interactive (Indiv.)" 2 "NR Interactive (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nri_ci_rel_unrest.png, replace  
...
graph twoway (connected nri_ind_rel nri_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   */  rarea lb_nri_ind_rel ub_nri_ind_rel quant, color(gray%40)  ||      /*
   */  rarea lb_nri_tot_rel ub_nri_tot_rel quant, color(gray%20)  ||      /*
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-0.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Interactive (Indiv.)" 2 "NR Interactive (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nri_ci_rel00_unrest.png, replace  
