...
capture log close
log using "$outputpfad\RIF_Decomp_rif_ind_fe_gender", replace
...
eststo: xi: bootstrap, reps(50): oaxaca rif_`q' age agesq sex urban for_lang_ex voca_foreign educ_high educ_med occup_tenure firm_tenure occup_tenure_sq firm_tenure_sq ///
...
*********-----------------------------**********************-----------------------------**********************
export delimited quant nra_rel nri_rel rm_rel nrm_rel occ_rel lb_occup_rel ub_occup_rel lb_nra_ind_rel ub_nra_ind_rel lb_nri_ind_rel ub_nri_ind_rel lb_rm_ind_rel ub_rm_ind_rel lb_nrm_ind_rel ub_nrm_ind_rel using "RIF_exp_ind_fe_male", replace
...
graph export RIF_5_wgap_male.png, replace
...
graph export RIF_5_socio_male.png, replace
...
graph export RIF_5_foreign_male.png, replace
...
graph export RIF_5_educ_male.png, replace
...
graph export RIF_5_exp_male.png, replace
...
graph export RIF_5_tasks_male.png, replace 
...
graph export RIF_5_dummies_male.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_occ_ci_male.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_cog_ci_male.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_man_ci_male.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_man_occ_ci_male.png, replace 
...
*5. indiv.task broad & occ. dumies 
eststo: xi: bootstrap, reps(50): oaxaca rif_`q' (Age: age agesq) (Gender: sex) (Urban: urban) (Foreign_Language: for_lang_ex) (Foreign_Education: voca_foreign) ///
...
*********-----------------------------**********************-----------------------------**********************
export delimited quant nra_rel nri_rel rm_rel nrm_rel occ_rel lb_occup_rel ub_occup_rel lb_nra_ind_rel ub_nra_ind_rel lb_nri_ind_rel ub_nri_ind_rel lb_rm_ind_rel ub_rm_ind_rel lb_nrm_ind_rel ub_nrm_ind_rel using "RIF_exp_ind_fe90_male", replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_5_wgap90_male.png, replace
...
graph twoway (connected age_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Urban" 3 "95% CI"))
graph export RIF_5_socio90_male.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_5_foreign90_male.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_5_educ90_male.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_5_exp90_male.png, replace
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_male.png, replace 
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_5_dummies90_male.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_occ_ci_male.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_cog_ci_male.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_man_ci_male.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_man_occ_ci_male.png, replace 
...
*********-----------------------------**********************-----------------------------**********************
export delimited quant nra_rel nri_rel rm_rel nrm_rel occ_rel lb_occup_rel ub_occup_rel lb_nra_ind_rel ub_nra_ind_rel lb_nri_ind_rel ub_nri_ind_rel lb_rm_ind_rel ub_rm_ind_rel lb_nrm_ind_rel ub_nrm_ind_rel using "RIF_exp_ind_fe00_male", replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_5_wgap00_male.png, replace
...
graph twoway (connected age_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Urban" 3 "95% CI"))
graph export RIF_5_socio00_male.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_5_foreign00_male.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_5_educ00_male.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_5_exp00_male.png, replace
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_male.png, replace 
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_5_dummies00_male.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_occ_ci_male.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_cog_ci_male.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_man_ci_male.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_man_occ_ci_male.png, replace 
...
*********-----------------------------**********************-----------------------------**********************
export delimited quant nra_rel nri_rel rm_rel nrm_rel occ_rel lb_occup_rel ub_occup_rel lb_nra_ind_rel ub_nra_ind_rel lb_nri_ind_rel ub_nri_ind_rel lb_rm_ind_rel ub_rm_ind_rel lb_nrm_ind_rel ub_nrm_ind_rel using "RIF_exp_ind_fe_female", replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(0(0.1)0.5) title("Native-Foreign Wage Gap", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_5_wgap_female.png, replace
...
graph twoway (connected age_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Demographics", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Urban" 3 "95% CI"))
graph export RIF_5_socio_female.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Foreign Characteristics", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_5_foreign_female.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Education", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_5_educ_female.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Experience", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_5_exp_female.png, replace
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_female.png, replace 
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Other Controls", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_5_dummies_female.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_occ_ci_female.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_cog_ci_female.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_man_ci_female.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks_man_occ_ci_female.png, replace 
...
*********-----------------------------**********************-----------------------------**********************
export delimited quant nra_rel nri_rel rm_rel nrm_rel occ_rel lb_occup_rel ub_occup_rel lb_nra_ind_rel ub_nra_ind_rel lb_nri_ind_rel ub_nri_ind_rel lb_rm_ind_rel ub_rm_ind_rel lb_nrm_ind_rel ub_nrm_ind_rel using "RIF_exp_ind_fe90_female", replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(0(0.1)0.5) title("Native-Foreign Wage Gap: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_5_wgap90_female.png, replace
...
graph twoway (connected age_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Demographics: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Urban" 3 "95% CI"))
graph export RIF_5_socio90_female.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Foreign Characteristics: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_5_foreign90_female.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Education: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_5_educ90_female.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Experience: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_5_exp90_female.png, replace
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_female.png, replace 
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Other Controls: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_5_dummies90_female.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_occ_ci_female.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_cog_ci_female.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_man_ci_female.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks90_man_occ_ci_female.png, replace 
...
*********-----------------------------**********************-----------------------------**********************
export delimited quant nra_rel nri_rel rm_rel nrm_rel occ_rel lb_occup_rel ub_occup_rel lb_nra_ind_rel ub_nra_ind_rel lb_nri_ind_rel ub_nri_ind_rel lb_rm_ind_rel ub_rm_ind_rel lb_nrm_ind_rel ub_nrm_ind_rel using "RIF_exp_ind_fe00_female", replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(0(0.1)0.5) title("Native-Foreign Wage Gap: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_5_wgap00_female.png, replace
...
graph twoway (connected age_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Demographics: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Urban" 3 "95% CI"))
graph export RIF_5_socio00_female.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Foreign Characteristics: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_5_foreign00_female.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Education: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_5_educ00_female.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Experience: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_5_exp00_female.png, replace
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_female.png, replace 
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Other Controls: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_5_dummies00_female.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_occ_ci_female.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_cog_ci_female.png, replace   
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_man_ci_female.png, replace 
...
graph twoway (connected nra_rel nri_rel rm_rel nrm_rel occ_rel quant, msymbol(D U S T) lpattern(solid dash dot shortdash_dot) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Interactive (Indiv.)" 3 "Rout. Man. (Indiv.)" 4 "NR Manual (Indiv.)" 5 "Occupation" 6 "95% CI"))
graph export RIF_5_tasks00_man_occ_ci_female.png, replace 
