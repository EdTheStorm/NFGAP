...
capture log close
log using "$outputpfad\RIF_Decomp_rif_ind_occ_task_restricted_immi3", replace
...
adsf
*********-----------------------------**********************-----------------------------**********************
**calculate iov-measures + CI
gen iov_nra =  nra_ind_rel/nra_occ_rel
gen iov_nri =  nri_ind_rel/nri_occ_rel
gen iov_rm =  rm_ind_rel/rm_occ_rel
gen iov_nrm =  nrm_ind_rel/nrm_occ_rel

gen iov_nra_lb =  lb_nra_ind_rel/lb_nra_occ_rel
gen iov_nri_lb =  lb_nri_ind_rel/lb_nri_occ_rel
gen iov_rm_lb =  lb_rm_ind_rel/lb_rm_occ_rel
gen iov_nrm_lb =  lb_nrm_ind_rel/lb_nrm_occ_rel

gen iov_nra_ub =  ub_nra_ind_rel/ub_nra_occ_rel
gen iov_nri_ub =  ub_nri_ind_rel/ub_nri_occ_rel
gen iov_rm_ub =  ub_rm_ind_rel/ub_rm_occ_rel
gen iov_nrm_ub =  ub_nrm_ind_rel/ub_nrm_occ_rel


export excel quant nri_ind_rel nri_occ_rel lb_nri_occ_rel ub_nri_occ_rel lb_nri_occ ub_nri_occ lb_nri_ind ub_nri_ind lb_nri_ind_rel ub_nri_ind_rel iov_nri iov_nri_lb iov_nri_ub using  "IOV_ind_occ", firstrow(variables) nolabel replace
...
graph export RIF_4_wgap_all.png, replace
...
graph export RIF_4_socio_all.png, replace
...
graph export RIF_4_foreign_all.png, replace
...
graph export RIF_4_educ_all.png, replace
...
graph export RIF_4_exp_all.png, replace
...
graph export RIF_4_tasks_occ_all.png, replace 
...
graph export RIF_4_tasks_ind_all.png, replace
...
graph export RIF_4_dummies_all.png, replace 
...
graph export RIF_4_tasks_ind_nra_ci_rel.png, replace  
...
graph export RIF_4_tasks_ind_nri_ci_rel.png, replace  
...
graph export RIF_4_tasks_ind_rm_ci_rel.png, replace  
...
graph export RIF_4_tasks_ind_nrm_ci_rel.png, replace  
...
export excel quant nri_ind_rel nri_occ_rel lb_nri_occ_rel ub_nri_occ_rel lb_nri_occ ub_nri_occ lb_nri_ind ub_nri_ind lb_nri_ind_rel ub_nri_ind_rel iov_nri iov_nri_lb iov_nri_ub using  "IOV_ind_occ90", firstrow(variables) nolabel replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_4_wgap90.png, replace
...
graph twoway (connected age_rel gender_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Sex" 3 "Urban" 4 "95% CI"))
graph export RIF_4_socio90.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_4_foreign90.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_4_educ90.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_4_exp90.png, replace
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_4_dummies90.png, replace 
...
graph twoway (connected nra_ind_rel nra_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Analytic (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nra_ci_rel90.png, replace  
...
graph twoway (connected nri_ind_rel nri_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Interactive (Indiv.)" 2 "NR Interactive (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nri_ci_rel90.png, replace  
...
graph twoway (connected rm_ind_rel rm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Rout. Manual (Indiv.)" 2 "Rout. Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_rm_ci_rel90.png, replace  
...
graph twoway (connected nrm_ind_rel nrm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 1992-1999", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Manual (Indiv.)" 2 "NRM Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nrm_ci_rel90.png, replace   
...
export excel quant nra_ind_rel nra_occ_rel lb_nra_occ_rel ub_nra_occ_rel lb_nra_occ ub_nra_occ lb_nra_ind ub_nra_ind lb_nra_ind_rel ub_nra_ind_rel iov_nra iov_nra_lb iov_nra_ub nri_ind_rel nri_occ_rel lb_nri_occ_rel ub_nri_occ_rel lb_nri_occ ub_nri_occ lb_nri_ind ub_nri_ind lb_nri_ind_rel ub_nri_ind_rel iov_nri iov_nri_lb iov_nri_ub rm_ind_rel rm_occ_rel lb_rm_occ_rel ub_rm_occ_rel lb_rm_occ ub_rm_occ lb_rm_ind ub_rm_ind lb_rm_ind_rel ub_rm_ind_rel iov_rm iov_rm_lb iov_rm_ub nrm_ind_rel nrm_occ_rel lb_nrm_occ_rel ub_nrm_occ_rel lb_nrm_occ ub_nrm_occ lb_nrm_ind ub_nrm_ind lb_nrm_ind_rel ub_nrm_ind_rel iov_nrm iov_nrm_lb iov_nrm_ub using "IOV_ind_occ00", firstrow(variables) nolabel replace
...
graph twoway connected natfor_diff quant ||  /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_4_wgap00.png, replace
...
graph twoway (connected age_rel gender_rel urban_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Age" 2 "Sex" 3 "Urban" 4 "95% CI"))
graph export RIF_4_socio00.png, replace
...
graph twoway (connected forlang_rel foreduc_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Foreign Language" 2 "Foreign Education" 3 "95% CI"))
graph export RIF_4_foreign00.png, replace
...
graph twoway (connected college_rel voca_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "College Degree" 2 "Vocational Degree" 3 "95% CI"))
graph export RIF_4_educ00.png, replace
...
graph twoway (connected tenocc_rel tenfirm_rel quant, msymbol(D U) lpattern(solid dash) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Tenure (Occup.)" 2 "Tenure (Firm.)" 3 "95% CI"))
graph export RIF_4_exp00.png, replace
...
graph twoway (connected year_rel state_rel ind_rel quant, msymbol(D U S) lpattern(solid dash dot) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Year" 2 "State" 3 "Industry" 4 "95% CI"))
graph export RIF_4_dummies00.png, replace 
...
graph twoway (connected nra_ind_rel nra_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Analytic (Indiv.)" 2 "NR Analytic (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nra_ci_rel00.png, replace  
...
graph twoway (connected nri_ind_rel nri_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Interactive (Indiv.)" 2 "NR Interactive (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nri_ci_rel00.png, replace  
...
graph twoway (connected rm_ind_rel rm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Rout. Manual (Indiv.)" 2 "Rout. Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_rm_ci_rel00.png, replace  
...
graph twoway (connected nrm_ind_rel nrm_total_rel quant, msymbol(T S) lpattern(dash solid) ) || /*
   ...
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-.5(0.25)1) title("Tasks - Individual: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "NR Manual (Indiv.)" 2 "NRM Manual (Total)" 3 "95% CI"))
graph export RIF_4_tasks_ind_nrm_ci_rel00.png, replace  
...
graph twoway connected natfor_diff quant ||  /*
   */  rarea lb_gap ub_gap quant, color(gray%20)  ||      /*
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-0.1(0.05)0.2) title("Native-Foreign Wage Gap", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_4_wgap_all.png, replace
...
graph twoway connected natfor_diff quant ||  /*
   */  rarea lb_gap ub_gap quant, color(gray%20)  ||      /*
   */, xlabel(0.0 .2 .4 .6 .8 1) ylabel(-0.1(0.05)0.2) title("Native-Foreign Wage Gap: 2006-2018", size(medium)) ytitle("Percent", size(small)) xtitle("Quantile", size(small)) /*
   */  yline(0.0, lw(thin) lc(black)) legend(order(1 "Wage Gap" 2 "95% CI"))
graph export RIF_4_wgap00.png, replace
