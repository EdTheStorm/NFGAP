...
global bibb_12 bibb2012.dta

global bibb_12_clean BIBB_2012_clean.dta
global bibb_12_tasks BIBB_2012_TASKS.dta
global bibb_12_career BIBB_2012_CAREER.dta

global key8892 key_kdlb_88_92_3st
...
capture log close
log using "$outputpfad\bibb_12_rename_log", replace
...
local school_career stib S3 S4 F1202 F1207 F1208 F100_kldb2010_3d F100_kldb2010_2d F200 az F510 F515 F512_neu EB92o EB92g F1104 F1216_ej F1400 F500 F501 F502 F503 F504 F505 F510 F1607_02 F1607_03 F1607_04 F1607_05 F1607_06 F1607_07 F1607_08 F1607_09 F1607_10 F1607_11 F1607_12 F1607_13 F1607_14 F1607_99n AB1_92g AB2_92g AB3_92g AB4_92g AB5_92g F1204 G1204 H1204 I1204 J1204 EB1_92o F1403 WZ2003

local tasks F411_03 F301 F303 F304 F305 F306 F307 F308 F309 F310 F311 F312 F313 F314 F315 F316 F317 F318 F319 F320 F325_01 F325_03 F325_05 F327_05 F403_01 F403_05 F403_06 F411_02 F403_05 F403_06
...
local socioecon S1 S2_j Zpalter F233 F518 F1607_01 Gkpol Bula

local weights Des2012 Gew2012 Gew2012_hr
...
keep `school_career' `besonders_skills' `jobanforderungen' `comp_specifics' `tools' `tasks' `socioecon' `weights' `misc' id year stib `lang'
...
rename Des2012 weight_desing
rename Gew2012 weight_12
rename Gew2012_hr weight_12_hr
...
rename EB92o occup_92_3st
rename EB92g occup_92_2st
 
rename F200 occup_hours_w
rename az occup_hours_w2
...
gen educ_high = (degree_voca==3 | degree_voca==4 | degree_voca==7 | degree_voca==8)
gen educ_med = (degree_voca==1 | degree_voca==2 | degree_voca==5 | degree_voca==6) 
...
use "$datenpfad\$bibb_12_clean", clear
...
keep id year voca_foreign occ_change occup_branch app_occup_3st occup_pos occup_hours_w2 age state population weight_desing weight_12 weight_12_hr sex birthyear degree /// 
educ_foreign occup_10_3st for_lang_ex for_lang occup occup_hours_w state_firm occup_tenure firm_tenure degree_year degree_voca_year occup_firmsize income /// 
degree_voca school_type school_type2 industry citizen_dummy educ_high educ_med educ_low worker employee master_employee employee_tasks instructions /// 
...
*school*
save "$datenpfad\$bibb_12_career", replace
